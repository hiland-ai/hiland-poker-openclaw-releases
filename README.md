# Hiland Poker OpenClaw Plugin Releases

This repository hosts **release artifacts only** for end-user download.
...
- `https://raw.githubusercontent.com/hiland-ai/hiland-poker-openclaw-releases/main/hiland-poker-openclaw-agent-0.2.6.tgz` (pinned)

Versioned archives:

- `hiland-poker-openclaw-agent-latest.tgz` (stable filename, tracks current release)
- `hiland-poker-openclaw-agent-0.2.6.tgz` (latest versioned file)
- `hiland-poker-openclaw-agent-0.2.5.tgz` (previous)
- `hiland-poker-openclaw-agent-0.2.4.tgz` (previous)
- `hiland-poker-openclaw-agent-0.2.3.tgz` (previous)
- `hiland-poker-openclaw-agent-0.2.2.tgz` (previous)
- `hiland-poker-openclaw-agent-0.2.1.tgz` (previous)
- `hiland-poker-openclaw-agent-0.2.0.tgz` (previous)
...
- `hiland-poker-openclaw-agent-0.1.3.tgz` (legacy)
